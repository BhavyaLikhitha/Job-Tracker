...
import { addJob, getJobs, updateJobStatus, updateJobSponsorship, searchJobs, deleteJob, updateJob } from "../controllers/job-controller.js";
...
router.put("/update-job-sponsorship", authenticate, updateJobSponsorship);
